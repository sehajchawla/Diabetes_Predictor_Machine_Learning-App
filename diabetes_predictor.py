#logistic regression gives an output that is discrete rather than continous
#logistic regression & newtons method is used together when data set is small and a discrete outut is required
...
r = 0.95 # covariance between x and z (related very closely)
